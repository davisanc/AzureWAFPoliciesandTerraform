...
//adding firewall policy to firewall
...
resource "azurerm_firewall_policy_rule_collection_group" "example" {
  ...
  nat_rule_collection {
    ...
    rule {
      ...
      translated_address  = azurerm_private_endpoint_connection.privateendpoint.private_service_connection[0].private_ip_address
      translated_port     = "80"
    }
  }
}
